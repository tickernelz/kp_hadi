            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="form-check w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-2" data-target="#input-sizing" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
                <div id="input-sizing" class="p-5">
                    <div class="preview">
                        ...
                        <input type="text" class="form-control mt-2" placeholder="Default input"
                            aria-label="default input example">
                        <input type="text" class="form-control form-control-sm mt-2" placeholder=".form-control-sm"
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="form-check w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-3" data-target="#input-groups" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="form-check w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-4" data-target="#input-state" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
                <div id="input-state" class="p-5">
                    <div class="preview">
                        <div>
                            ...
                            <input id="input-state-1" type="text" class="form-control border-theme-20"
                        ...
                        <div class="mt-3">
                            ...
                            <input id="input-state-2" type="text" class="form-control border-theme-15"
                                placeholder="Input text">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="input-state-3" type="text" class="form-control border-theme-21"
                                placeholder="Input text">
                ...
                <div id="select-options" class="p-5">
                    <div class="preview">
                        <div class="flex flex-col sm:flex-row items-center">
                            <select class="form-select form-select-lg sm:mt-2 sm:mr-2"
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="form-check w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-8" data-target="#inline-form" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="form-check w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-10" data-target="#radio" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
