            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-1" data-target="#heading" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
                <div id="heading" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-5">
                            ...
                            <h2 class="text-3xl text-gray-700 dark:text-gray-600 font-medium leading-none mt-3">h2.
                                Heading 2</h2>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-2" data-target="#text-settings"
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-3" data-target="#common-elements"
                            class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                <div id="common-elements" class="p-5">
                    <div class="preview">
                        ...
                        <ins class="block mt-1">This line of text is meant to be treated as an addition to the
                            document.
                        </ins>
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-4" data-target="#badge" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
                <div id="badge" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-2">
                            ...
                            <span
                                class="text-xs px-1 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                        ...
                        <div class="mt-3">
                            ...
                            <span
                                class="px-2 py-1 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                        ...
                        <div class="mt-4">
                            ...
                            <span
                                class="px-3 py-2 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                        ...
                        <div class="mt-6">
                            ...
                            <span
                                class="px-4 py-3 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                        ...
                        <div class="mt-2">
                            ...
                            <span
                                class="text-xs px-1 border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                        ...
                        <div class="mt-4">
                            <span
                                class="px-3 py-2 rounded-full border border-theme-25 text-theme-25 dark:text-theme-22 dark:border-theme-22 mr-1">1</span>
                            <span
                                class="px-3 py-2 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                            <span
                                class="px-3 py-2 rounded-full border border-theme-20 text-theme-20 dark:border-theme-20 mr-1">3</span>
                            <span
                                class="px-3 py-2 rounded-full border border-theme-15 text-theme-15 dark:border-theme-15 mr-1">4</span>
                            <span
                                class="px-3 py-2 rounded-full border border-theme-21 text-theme-21 dark:border-theme-21 mr-1">5</span>
                        </div>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-5" data-target="#separator" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-6" data-target="#devider" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-7" data-target="#link" class="show-code form-check-switch mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
