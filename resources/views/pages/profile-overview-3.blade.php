                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    ...
                    <div class="tiny-slider py-5" id="announcement">
                        <div class="px-5">
                            ...
                            <div class="text-gray-700 dark:text-gray-600 mt-2">Lorem Ipsum is simply dummy text of the
                                printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                text ever. <br><br> Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry since the 1500s.
                            </div>
                            <div class="flex items-center mt-5">
                                <div
                                    class="px-3 py-2 bg-theme-19 dark:bg-dark-5 dark:text-gray-300 text-theme-22 rounded font-medium">
                                    02 June 2021
                                </div>
