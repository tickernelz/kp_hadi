    ...
    <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            ...
            <div class="grid grid-cols-12 gap-5 mt-5">
                ...
                <div
                    class="col-span-12 sm:col-span-4 2xl:col-span-3 box bg-theme-25 dark:bg-theme-25 p-5 cursor-pointer zoom-in">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer text-right">
                    <button type="button" data-dismiss="modal" class="btn btn-outline-secondary w-32 mr-1">Cancel
                    </button>
    ...
    <div id="add-item-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer text-right">
                    <button type="button" data-dismiss="modal" class="btn btn-outline-secondary w-24 mr-1">Cancel
                    </button>
