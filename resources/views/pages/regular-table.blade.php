                        ...
                        <div class="overflow-x-auto">
                            ...
                            <table class="table mt-5">
                                ...
                                <tr class="bg-gray-700 dark:bg-dark-1 text-white">
                                    ...
                                    <th class="border-b-2 dark:border-dark-5 border-gray-600 whitespace-nowrap">First
                                        Name
                                    </th>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input data-target="#bordered-table" class="show-code form-check-switch mr-0 ml-3"
                ...
                <div class="p-5" id="bordered-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-bordered-table"
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input data-target="#hoverable-table" class="show-code form-check-switch mr-0 ml-3"
                ...
                <div class="p-5" id="hoverable-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-hoverable-table"
                                class="copy-code btn py-1 px-2 btn-outline-secondary">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto mt-3 rounded-md">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input data-target="#row-states-table" class="show-code form-check-switch mr-0 ml-3"
                ...
                <div class="p-5" id="row-states-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-row-states-table"
                                class="copy-code btn py-1 px-2 btn-outline-secondary">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto mt-3 rounded-md">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input data-target="#responsive-table" class="show-code form-check-switch mr-0 ml-3"
                               type="checkbox" id="show-example-6">
                    </div>
                </div>
                <div class="p-5" id="responsive-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-responsive-table"
                                class="copy-code btn py-1 px-2 btn-outline-secondary">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto mt-3 rounded-md">
