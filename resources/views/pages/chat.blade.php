                ...
                <div id="chats" class="tab-pane active" role="tabpanel" aria-labelledby="chats-tab">
                                ...
                                <div class="flex mt-5">
                                    @foreach (array_slice($fakers, 0, 10) as $faker)
                                        <a href="" class="w-10 mr-4 cursor-pointer">
                                            ...
                                            <div
                                                class="text-xs text-gray-600 truncate text-center mt-2">{{ $faker['users'][0]['name'] }}</div>
                                        </a>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
                        @foreach (array_slice($fakers, 0, 10) as $key => $faker)
                            <div
                                class="intro-x cursor-pointer box relative flex items-center p-5 {{ $key ? 'mt-5' : '' }}">
                                ...
                                @if ($faker['true_false'][0])
                                    <div
                                        class="w-5 h-5 flex items-center justify-center absolute top-0 right-0 text-xs text-white rounded-full bg-theme-25 font-medium -mt-1 -mr-1">{{ $faker['notification_count'] }}</div>
                                @endif
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="pt-4 pb-10 sm:py-4 flex items-center border-t border-gray-200 dark:border-dark-5">
                        ...
                        <div class="flex absolute sm:static left-0 bottom-0 ml-5 sm:ml-0 mb-5 sm:mb-0">
                            <div class="dropdown mr-3 sm:mr-5">
                                <a href="javascript:" class="dropdown-toggle w-4 h-4 sm:w-5 sm:h-5 block text-gray-600"
                                   aria-expanded="false">
                        ...
                        <a href="javascript:"
                           class="w-8 h-8 sm:w-10 sm:h-10 block bg-theme-25 text-white rounded-full flex-none flex items-center justify-center mr-5">
