            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-1" data-target="#basic-datepicker"
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-2" data-target="#input-group-datepicker"
                            class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                <div id="input-group-datepicker" class="p-5">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-input-group-datepicker"
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-3" data-target="#daterangepicker"
                            class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-4" data-target="#modal-datepicker"
                            class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                        <div class="col-span-12 sm:col-span-6">
                                            ...
                                            <input id="modal-datepicker-1" class="datepicker form-control"
                                                data-single-mode="true">
                                        </div>
                                        <div class="col-span-12 sm:col-span-6">
                                            <label for="modal-datepicker-2" class="form-label">To</label>
                                            <input id="modal-datepicker-2" class="datepicker form-control"
                                                data-single-mode="true">
                                        </div>
                                    </div>
                                    <!-- END: Modal Body -->
                        ...
                        <div class="overflow-y-auto mt-3 rounded-md">
                            <pre id="copy-modal-datepicker" class="source-preview">
                                    <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                                        ...
                                        <!-- END: Show Modal Toggle --><!-- BEGIN: Modal Content --><div id="datepicker-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
