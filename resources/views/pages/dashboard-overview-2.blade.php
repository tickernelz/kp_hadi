        ...
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="report-box-2 intro-y mt-12 sm:mt-5">
                        <div class="box sm:flex">
                            <div class="px-8 py-12 flex flex-col justify-center flex-1">
                                ...
                                <div class="report-box-2__indicator bg-theme-20 tooltip cursor-pointer"
                                    title="47% Higher than last month">
                                    47% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i>
                                </div>
                                <div class="mt-4 text-gray-600 dark:text-gray-600">Sales earnings this month after
                                    associated author fees, & before taxes.
                                </div>
                                <button class="btn btn-outline-secondary relative justify-start rounded-full mt-12">
                                    Download Reports
                                    <span
                                        class="w-8 h-8 absolute flex justify-center items-center bg-theme-25 text-white rounded-full right-0 top-0 bottom-0 my-auto ml-auto mr-0.5">
                    ...
                    <div class="report-box-2 intro-y mt-5">
                        <div class="box p-5">
                            ...
                            <div class="border-b border-gray-200 flex pb-2 mt-4">
                                ...
                                <div class="text-theme-20 flex text-xs font-medium tooltip cursor-pointer ml-auto"
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 mt-2 lg:mt-6 xl:mt-2">
                    ...
                    <div class="report-box-2 intro-y mt-5">
                        <div class="box p-5">
                            <div class="boxed-tabs nav nav-tabs justify-center w-4/5 bg-gray-200 text-gray-600 dark:bg-dark-1 dark:text-gray-500 rounded-md mx-auto"
                                role="tablist">
                ...
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="ads-box box p-8 relative overflow-hidden bg-theme-24 intro-y">
                        <div class="ads-box__title w-full sm:w-72 text-white text-xl -mt-3">Transact safely with
                        ...
                        <button class="btn w-32 bg-white dark:bg-dark-2 dark:text-white mt-6 sm:mt-10">Start Now
                        </button>
                ...
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="ads-box box p-8 relative overflow-hidden intro-y">
                        <div class="ads-box__title w-full sm:w-52 text-theme-24 dark:text-white text-xl -mt-3">Invite
                            friends to get <span class="font-medium">FREE</span> bonuses!
                        </div>
                        <div class="w-full sm:w-60 leading-relaxed text-gray-600 mt-2">Get a IDR 100,000 voucher by
                            ...
                            <div class="intro-x box">
                                <div class="p-5">
                                    ...
                                    <div class="grid grid-cols-7 gap-4 mt-5 text-center">
                                        ...
                                        <div class="py-0.5 bg-theme-24 dark:bg-theme-25 text-white rounded relative">8
                                        </div>
