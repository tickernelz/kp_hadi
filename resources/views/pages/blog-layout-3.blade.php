...
@section('subcontent')
    <div class="intro-y news xl:w-3/5 p-5 box mt-8">
        ...
        <div class="intro-y text-gray-700 dark:text-gray-600 mt-3 text-xs sm:text-sm">
            {{ $fakers[0]['dates'][0] }} <span class="mx-1">•</span> <a class="text-theme-25 dark:text-theme-22"
                href="">{{ $fakers[0]['products'][0]['category'] }}</a>
        ...
        <div class="intro-y flex relative pt-16 sm:pt-6 items-center pb-6">
            <a href=""
                class="intro-x w-8 h-8 sm:w-10 sm:h-10 flex flex-none items-center justify-center rounded-full border border-gray-400 dark:border-dark-5 dark:bg-dark-5 dark:text-gray-300 text-gray-600 mr-3 tooltip"
                title="Bookmark">
                <i data-feather="bookmark" class="w-3 h-3"></i>
            </a>
            <div class="intro-x flex mr-3">
                <div class="intro-x w-8 h-8 sm:w-10 sm:h-10 image-fit">
                    <img alt="Tinker Tailwind HTML Admin Template" class="rounded-full border border-white zoom-in tooltip"
            ...
            <a href=""
                class="intro-x w-8 h-8 sm:w-10 sm:h-10 flex flex-none items-center justify-center rounded-full bg-theme-19 dark:bg-dark-5 dark:text-gray-300 text-theme-22 ml-auto sm:ml-0 tooltip"
                title="Share">
                <i data-feather="share-2" class="w-3 h-3"></i>
            </a>
            <a href=""
                class="intro-x w-8 h-8 sm:w-10 sm:h-10 flex flex-none items-center justify-center rounded-full bg-theme-25 text-white ml-3 tooltip"
                title="Download PDF">
        ...
        <div
            ...
            <div class="flex items-center text-gray-700 dark:text-gray-600 sm:ml-auto mt-5 sm:mt-0">
                Share this post:
                <a href=""
                    class="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center border dark:border-dark-5 ml-2 text-gray-500 zoom-in tooltip"
                    title="Facebook">
        ...
        <div class="intro-y mt-5 pt-5 border-t border-gray-200 dark:border-dark-5">
            ...
            <div class="news__input relative mt-5">
                ...
                <textarea class="form-control border-transparent bg-gray-200 pl-16 py-6 placeholder-theme-13 resize-none"
                    rows="1" placeholder="Post a comment..."></textarea>
            </div>
        </div>
