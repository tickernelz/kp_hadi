...
@push('judul', 'Tambah Kelompok Nilai')
@push('breadcrumb', 'Tambah Kelompok Nilai')
            ...
            <div class="intro-y box p-5">
                <form name="tambah" id="tambah" method="post" action="javascript:void(0)">
                    ...
                    <div class="mt-3">
                        ...
                        <input id="nama_kelompok" name="nama_kelompok" type="text" class="form-control w-full mb-3">
                    </div>
        ...
        if ($("#tambah").length > 0) {
            $("#tambah").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('kelola.kelompok_nilai.tambah.post') }}",
                        type: "POST",
