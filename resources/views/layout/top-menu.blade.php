    ...
    <div class="top-bar-boxed border-b border-theme-3 px-4 md:px-6 mb-14 md:mb-8">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <img alt="Logo SDN 6 Panarung" class="w-6" src="{{ asset('dist/images/logo.svg') }}">
            ...
            <div class="-intro-x breadcrumb breadcrumb--light mr-auto">
                <a href="{{ route('beranda') }}">Aplikasi</a>
                <i data-feather="chevron-right" class="breadcrumb__icon"></i>
                <a href="" class="breadcrumb--active">@stack('breadcrumb')</a>
            </div>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
...
{{--                                    <div--}}
{{--                                        class="ml-auto w-48 truncate text-gray-600 text-xs text-right">{{ $faker['users'][0]['email'] }}</div>--}}
{{--                                </a>--}}
{{--                            @endforeach--}}
{{--                        </div>--}}
...
{{--                                <div--}}
{{--                                    class="ml-auto w-48 truncate text-gray-600 text-xs text-right">{{ $faker['products'][0]['category'] }}</div>--}}
{{--                            </a>--}}
{{--                        @endforeach--}}
{{--                    </div>--}}
{{--                </div>--}}
                ...
                <div class="dropdown-menu w-56">
                    <div class="dropdown-menu__content box dark:bg-dark-6">
                        <div class="p-4 border-b border-black border-opacity-5 dark:border-dark-3">
                            ...
                            <div
                                class="text-xs text-gray-600 mt-0.5 dark:text-gray-600">{{ $fakers[0]['jobs'][0] }}</div>
                        </div>
                        <div class="p-2">
                            <a href=""
